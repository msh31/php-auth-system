    ...
    <div class="max-w-7xl mx-auto">
        <div class="flex justify-between items-center mb-6">
            ...
            <div class="flex gap-3">
                ...
                <a href="<?php echo BASE_URL; ?>admin" class="px-4 py-2 bg-[var(--bg-card)] border border-[var(--border-color)] text-white rounded-lg hover:bg-[var(--bg-secondary)] transition-colors">
